...
const FloatingButtonComponent: React.FC<FloatingButtonComponentProps> =
  memo<FloatingButtonComponentProps>(
    ({
      ...
      const isSolid = gradient[0] === gradient[1];
        ...
        >
          <Svg width={buttonSize} height={buttonSize}>
            ...
            <Circle
              ...
              cy={buttonSize / 2}
              r={buttonSize / 2.2}
              fill={isSolid ? gradient[0] : "url(#floatingButtonGradient)"}
            />
          </Svg>
          <View
            style={{
      ...
      return (
        <View style={{ overflow: "hidden", width: screenWidth }}>
          <Animated.View style={animatedStyle}>
            ...
            >
              <Path d={path} fill={isSolid ? gradient[0] : "url(#curveGradient)"} />
              <Defs>
                <SvgGradient
                  id="curveGradient"
                  x1={0}
                ...
                >
                  {isActive ? (
                    <FloatingButtonComponent
                      ...
                      gradient={["#C4175C", "#C4175C"]} // Force active button to always be red logo color
                      scale={buttonScale}
                      shadow={shadow}
                      badge={tab.badge}
                    />
...
const createStyles = <T extends StyleConfig>({
  ...
  StyleSheet.create({
    ...
    tabTouchable: {
      ...
      justifyContent: "center",
      flex: 1,
      paddingBottom: Platform.OS === "ios" ? VIEWPORT_HEIGHT * 2.5 : VIEWPORT_HEIGHT * 1.5,
    },
    tabLabel: {
      fontSize: textSize,
      fontFamily,
...
> &
  ...
  memo(
    ({
      ...
      descriptors,
      navigation,
      gradients = ["#FFFFFF", "#FFFFFF"], // Default to white
    }) => {
        ...
        return {
          ...
          icon: options?.tabBarIcon
            ? options.tabBarIcon({
                ...
                size: isActive ? 28 : 24, // slightly larger when floating
              })
            : null,
          badge:
